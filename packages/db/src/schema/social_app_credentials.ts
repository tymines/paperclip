...
export const socialAppCredentials = pgTable(
  "social_app_credentials",
  {
    ...
    consumerSecretEncrypted: jsonb("consumer_secret_encrypted"),
    consumerSecretLast4: text("consumer_secret_last4"),
    bearerTokenEncrypted: jsonb("bearer_token_encrypted"),
    bearerTokenLast4: text("bearer_token_last4"),
