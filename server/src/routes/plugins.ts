...
// extractSecretRefPathsFromConfig and PLUGIN_SECRET_REFS_DISABLED_MESSAGE
// removed - self-hosted secret-ref fix re-enables live resolution via
// injectable secretService. The config-save gate is no longer needed.
