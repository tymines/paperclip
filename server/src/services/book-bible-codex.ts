...
/** Gated-migration pattern (0160), same as passage_locks/0159. */
...
export const PENDING_0160 =
  "Story Bible codex tables pending migration 0160 — codex unavailable until it is applied.";
 ...
 * table: pre-0160 there are simply no facts.
 */
