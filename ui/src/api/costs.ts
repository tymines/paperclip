...
function fleetDashboardParams(input: {
  from?: string;
  to?: string;
  projectId?: string;
  issueId?: string;
...
export const costsApi = {
  ...
  fleetDashboard: (companyId: string, input: {
    from?: string;
    to?: string;
    projectId?: string;
    issueId?: string;
    ...
    api.get<FleetCostDashboardPayload>(`/companies/${companyId}/costs/fleet-dashboard${fleetDashboardParams(input)}`),
