...
export function ToastViewport() {
  ...
  return (
    <aside
      aria-live="polite"
      aria-atomic="false"
      className="pointer-events-none fixed bottom-[calc(4.75rem+env(safe-area-inset-bottom))] left-3 right-3 z-[120] w-auto max-w-sm px-1 md:bottom-3 md:right-auto md:w-full"
    >
