...
export function WarRoomHermesChat() {
  ...
  return (
    <div style={{ background: DS.canvas, color: DS.text, display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }}>
      {/* Header */}
...
export default WarRoomHermesChat;
