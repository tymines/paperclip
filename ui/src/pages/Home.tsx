...
/* -------------------------------------------------------------------------- */
/* Talk to Hermes doorway                                                     */
/* -------------------------------------------------------------------------- */
function HermesDoorway({ companyId, companyPrefix }: { companyId: string; companyPrefix?: string }) {
  ...
  return (
    <section style={surfaceCard} className="flex flex-col p-5">
      <div className="mb-1 flex items-center gap-2">
        <SectionLabel>Talk to Hermes</SectionLabel>
      </div>
      <p className="mb-3 text-[12px]" style={{ color: DS.textFaint }}>
        Your chief of staff. Delegate, ask, strategize.
      </p>
      ...
      >
        ...
        <button
          ...
          aria-label="Voice"
          title="Open War Room to speak with Hermes"
        >
...
export function Home() {
  ...
  return (
    ...
    >
      ...
      {/* 3 + 4 — Hermes doorway + Waiting on you */}
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.3fr)]">
        <HermesDoorway companyId={selectedCompanyId} companyPrefix={companyPrefix} />
        <WaitingOnYou
